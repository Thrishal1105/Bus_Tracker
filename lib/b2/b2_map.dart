...
import 'dart:convert';
import './b2_routes.dart';
import './b2_driver_info.dart';
import 'dart:async';

class B2MapPage extends StatefulWidget {
  const B2MapPage({super.key});

  @override
  State<B2MapPage> createState() => _B2MapPageState();
}

class _B2MapPageState extends State<B2MapPage> {
  LatLng? busLocation;
  bool isLoading = true;
  String? error;
  Timer? _timer;
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const B2RoutesPage()),
                    );
                  },
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const B2DriverInfoPage()),
                    );
                  },
